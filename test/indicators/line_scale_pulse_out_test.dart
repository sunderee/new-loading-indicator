...
import 'package:new_loading_indicator/src/indicators/line_scale_pulse_out.dart';
import 'package:new_loading_indicator/src/shape/indicator_painter.dart';

void main() {
  group('LineScalePulseOut', () {
        ...
        MaterialApp(
          home: DecorateContext(
            decorateData: DecorateData(
              indicator: Indicator.lineScalePulseOut,
              colors: const [Colors.blue],
              pause: false,
            ),
            child: const LineScalePulseOut(),
          ),
        ),
      );
    ...
    testWidgets('animations are properly configured with delays', (
      ...
      for (final heightFactor in longerDelayHeightFactors) {
        expect(
          heightFactor! >= 0.4 && heightFactor <= 1.0,
          isTrue,
          reason: 'Height factor should stay between 0.4 and 1.0',
        );
      }
