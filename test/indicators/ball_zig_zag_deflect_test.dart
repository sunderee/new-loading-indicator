...
import 'package:new_loading_indicator/src/indicators/ball_zig_zag_deflect.dart';
import 'package:new_loading_indicator/src/shape/indicator_painter.dart';

void main() {
  group('BallZigZagDeflect', () {
    testWidgets('renders correct number of shapes and transforms', (
        ...
        MaterialApp(
          home: DecorateContext(
            decorateData: DecorateData(
              indicator: Indicator.ballZigZagDeflect,
              colors: const [Colors.blue],
              pause: false,
            ),
            child: const BallZigZagDeflect(),
          ),
        ),
      );
      ...
      expect(
        find.descendant(
          of: find.byType(BallZigZagDeflect),
    ...
    testWidgets('circles move in opposite directions', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: SizedBox(
            width: 100,
